...
inner join(SELECT ProductID, lineTotal FROM  [INSTANCIA1].salesAW.sales.SalesOrderDetail sod
	WHERE SalesOrderID in( SELECT SalesOrderID FROM  [INSTANCIA1].salesAW.sales.SalesOrderHeader soh
		WHERE TerritoryID in( SELECT TerritoryID FROM  [INSTANCIA1].salesAW.sales.SalesTerritory st
...
BEGIN
	IF EXISTS (
		SELECT * FROM otherAW.Person.EmailAddress 
		WHERE BusinessEntityID in(
				SELECT BusinessEntityID 
				FROM otherAW.Person.Person as p
				WHERE p.FirstName=@fName AND p.LastName=@lName AND p.PersonType='SC'))
	BEGIN
		UPDATE otherAW.Person.EmailAddress SET EmailAddress = @correo
			WHERE BusinessEntityID in(
...
BEGIN
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory1  INNER JOIN otherAW.Person.Person as P ON territory1.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory2  INNER JOIN otherAW.Person.Person as P ON territory2.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory3  INNER JOIN otherAW.Person.Person as P ON territory3.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory4  INNER JOIN otherAW.Person.Person as P ON territory4.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory5  INNER JOIN otherAW.Person.Person as P ON territory5.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory6  INNER JOIN otherAW.Person.Person as P ON territory6.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory7  INNER JOIN otherAW.Person.Person as P ON territory7.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory8  INNER JOIN otherAW.Person.Person as P ON territory8.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory9  INNER JOIN otherAW.Person.Person as P ON territory9.SalesPersonID = P.BusinessEntityID
	...
	AS pedidos ORDER BY TerritoryID, Total_Pedidos DESC) AS territory10  INNER JOIN otherAW.Person.Person as P ON territory10.SalesPersonID = P.BusinessEntityID
